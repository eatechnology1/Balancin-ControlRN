...
void setup(){
   ...
   ///Creamos los datos para entrenar la RED//
      ...
      XI.WriteArray_2D(i,3,3.0*cos(i*0.1)+5.0);
      }
      
      for (int i = 1; i<69 ; i++)
     {    
       XI.WriteArray_2D(i-1,0,i*0.1);
       XI.WriteArray_2D(i-1,1,3.0*cos(i*0.1)+5.0);
       D.WriteArray_2D(0,i-1,3.0*cos(i*0.1)+5.0);
   ...
   for (byte i = 0; i<XF ; i++)
{
  ...
  Serial.print(" ");
  Serial.println(net.Ysim.ReadArray_2D(0,i),4);
